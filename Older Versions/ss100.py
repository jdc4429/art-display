...
class FIRE:
    def __init__(self):
        ...
        # Adjust the position to center the animation at the bottom
        self.animation_rect = self.frames[0].get_rect()
        self.animation_rect.midbottom = (screen_width // 2, screen_height)
    ...
    def draw(self):
        # Draw the animated fire effect at the bottom of the screen
        screen.blit(self.frames[self.frame_index], self.animation_rect)
