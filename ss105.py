...
class Raindrop:
    def __init__(self, x, y, speed):
        ...
        self.color = (random.randint(100, 255), random.randint(100, 255), random.randint(100, 255))  # Add color variation
    ...
    def draw(self):
        # Draw raindrop as a colored ellipse
...
class Special:
    def __init__(self, x, y, speed_x):
        ...
        self.size_x = random.randint(5, 20)
        self.size_y = random.randint(5, 20)
        self.original_size_y = self.size_y  # Store the original size for scaling
        self.color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        self.growing = True  # Flag to track if the block is growing or shrinking
        self.growth_rate = random.uniform(0.1, 0.5)  # Adjust the growth rate as needed
    ...
    def fall(self):
        ...
        if self.growing:
            self.size_y -= self.growth_rate  # Shrink vertically
        else:
            self.size_y += self.growth_rate  # Expand vertically

        if self.size_y < self.original_size_y * 0.5:  # Minimum size limit
            self.growing = False
        elif self.size_y > self.original_size_y:  # Original size limit
            self.growing = True
